...
function enableCam(event) {
    ...
    document.getElementById("captureB").style.display = "block";
  ...
  model.detect(video).then(function (predictions) {
    ...
    for (let n = 0; n < predictions.length; n++) {
      ...
      if (predictions[n].score > 0.66) {
        enableWebcamButton.innerHTML = predictions[n].class  + ' - with ' 
...
function capture() {
    ...
    document.getElementById("retakeB").style.display = "block";
...
document.getElementById("retake").addEventListener("click", ()=>{
  ...
  document.getElementById("retakeB").style.display = "none";
  document.getElementById("resultB").style.display = "none";
  // document.getElementById("retakeB").display = "none";
})
